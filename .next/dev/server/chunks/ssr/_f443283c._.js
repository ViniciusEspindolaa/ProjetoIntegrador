...
function NotificationsPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        async function fetchNotifications() {
            if (!user) return;
            try {
                const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiFetch"])('/api/notificacoes');
    ...
    const handleMarkAsRead = async (notificationId)=>{
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiFetch"])('/api/notificacoes/marcar-lidas', {
                method: 'POST',
                body: JSON.stringify({
                    ids: [
                        notificationId
    ...
    const handleViewNotification = async (notification)=>{
        ...
        if (notification.type === 'sighting' && !notification.sighting && notification.sightingId) {
            try {
                const sightingData = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiFetch"])(`/api/avistamentos/${notification.sightingId}`);
                if (sightingData) {
                    notifToView = {
                        ...notification,
                        sighting: {
...
//# sourceMappingURL=_f443283c._.js.map