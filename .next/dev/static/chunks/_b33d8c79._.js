...
function MobileNav() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "MobileNav.useEffect": ()=>{
            const fetchCount = {
                "MobileNav.useEffect.fetchCount": async ()=>{
                    try {
                        if (("TURBOPACK compile-time value", "object") !== 'undefined' && localStorage.getItem('token')) {
                            const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiFetch"])('/api/notificacoes');
                            const count = (res.data || []).filter({
                                "MobileNav.useEffect.fetchCount": (n)=>!n.lida
                            }["MobileNav.useEffect.fetchCount"]).length;
            ...
            }["MobileNav.useEffect.fetchCount"];
            fetchCount();
...
_s(MobileNav, "MVa3opSSFYxxu+fwNrZqAlCY2EE=", false, function() {
    return [
...
//# sourceMappingURL=_b33d8c79._.js.map