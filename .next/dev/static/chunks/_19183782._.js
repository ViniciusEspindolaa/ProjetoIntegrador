...
function NotificationsPage() {
            ...
            async function fetchNotifications() {
                ...
                try {
                    ...
                    const mapped = (res.data || []).map({
                        "NotificationsPage.useEffect.fetchNotifications.mapped": (n)=>({
                                id: n.id,
                                userId: n.usuarioId,
                    ...
                    }["NotificationsPage.useEffect.fetchNotifications.mapped"]);
    ...
    const handleMarkAsRead = async (notificationId)=>{
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiFetch"])('/api/notificacoes/marcar-lidas', {
                method: 'POST',
                body: JSON.stringify({
                    ids: [
                        notificationId
    ...
    const handleViewNotification = async (notification)=>{
        ...
        if (notification.type === 'sighting' && !notification.sighting && notification.sightingId) {
            try {
                const sightingData = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiFetch"])(`/api/avistamentos/${notification.sightingId}`);
                if (sightingData) {
                    notifToView = {
                        ...notification,
                        sighting: {
...
_s(NotificationsPage, "VzMo8JECU/Q20GqAfGAYTT8klfk=", false, function() {
    return [
...
//# sourceMappingURL=_19183782._.js.map