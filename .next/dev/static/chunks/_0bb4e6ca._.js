...
function SignupPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "SignupPage.useEffect": ()=>{
            const doReverse = {
                "SignupPage.useEffect.doReverse": async ()=>{
            ...
            }["SignupPage.useEffect.doReverse"];
            doReverse();
        }
    }["SignupPage.useEffect"], [
        mapLocation
    ...
    const handleSignup = async (e)=>{
        ...
        if (!emailRegex.test(email)) {
            toast({
                ...
                description: 'Informe um e-mail no formato exemplo@dominio.com.',
                variant: 'destructive'
            });
            return;
        }
        if (name.trim().length < 10) {
            toast({
                title: 'Nome inválido',
                description: 'Por favor informe seu nome completo (mínimo 10 caracteres).',
                variant: 'destructive'
            });
            return;
        }
        if (name.length > 60) {
            toast({
                ...
                description: 'O nome deve ter no máximo 60 caracteres.',
                variant: 'destructive'
            });
            return;
        }
        if (email.length > 40) {
            toast({
                ...
                description: 'O e-mail deve ter no máximo 40 caracteres.',
                variant: 'destructive'
            });
            return;
        }
        if (password.length < 8) {
            toast({
                ...
                description: 'Senha deve ter ao menos 8 caracteres.',
                variant: 'destructive'
            });
            return;
        }
        ...
        if (!(hasLower && hasUpper && hasNumber && hasSymbol)) {
            toast({
                title: 'Senha fraca',
                description: 'Senha deve conter letras maiúsculas, minúsculas, números e símbolos.',
                variant: 'destructive'
            });
            return;
        }
        ...
        if (sanitizedPhone.length === 0 || sanitizedPhone.length > 15) {
            toast({
                ...
                description: 'Informe um telefone com até 15 dígitos (ex: 5511999999999).',
                variant: 'destructive'
            });
            return;
        }
        if (!mapLocation) {
            toast({
                ...
                description: 'Por favor, selecione sua localização no mapa para receber alertas de pets próximos.',
                variant: 'destructive'
            });
            return;
        }
            ...
            if (error?.response?.erro) {
                if (typeof error.response.erro === 'string') {
                    ...
                    if (error.response.erro.issues) {
                        msg = error.response.erro.issues.map((i)=>i.message).join(', ');
                    } else {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: "min-h-screen flex items-center justify-center p-4 bg-linear-to-br from-teal-50 to-orange-50",
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardHeader"], {
                    ...
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            className: "mx-auto mb-4 w-16 h-16 bg-teal-600 rounded-full flex items-center justify-center",
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardDescription"], {
                            children: "Junte-se para ajudar pets a encontrarem seu caminho"
                        }, void 0, false, {
                            fileName: "[project]/app/signup/page.tsx",
                            lineNumber: 229,
                            columnNumber: 11
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Button"], {
                                                    ...
                                                    children: [
                                                        ...
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                            className: "sr-only",
                                                            children: showPassword ? 'Ocultar senha' : 'Mostrar senha'
                                                        }, void 0, false, {
                                                            fileName: "[project]/app/signup/page.tsx",
                                                            lineNumber: 292,
                                                            columnNumber: 19
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                            ...
                                            children: "Necessário para receber alertas de pets perdidos na sua região."
                                        }, void 0, false, {
                                            fileName: "[project]/app/signup/page.tsx",
                                            lineNumber: 332,
                                            columnNumber: 15
...
_s(SignupPage, "Jxl/7Kznt79138DDm0FUlxzbe94=", false, function() {
    return [
...
//# sourceMappingURL=_0bb4e6ca._.js.map