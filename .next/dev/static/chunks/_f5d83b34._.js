...
function SignupPage() {
    ...
    const handleSignup = async (e)=>{
        ...
        try {
            ...
            const msg = error?.message || error?.response?.erro || JSON.stringify(error?.response) || 'Erro ao criar conta';
            toast({
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: "min-h-screen flex items-center justify-center p-4 bg-gradient-to-br from-teal-50 to-orange-50",
...
_s(SignupPage, "kLx+ty9yN3hqePycQXMQ8ty1CK8=", false, function() {
    return [
...
//# sourceMappingURL=_f5d83b34._.js.map